                ...
                <form action="<?php echo $url_post ?>" method="post">
                    <div class="row g-3">
                        <div class="col-sm-6">
                            ...
                            <input type="text" readonly="readonly" class="form-control" value="<?= $kode; ?>" name="id_trans" placeholder="Kode Transaksi" required>
                        ...
                        <div class="col-sm-6 d-none cust_show">
                            ...
                            <select id="id_cust" name="id_cust" class="form-control">
                                <option value="0">--Pilih--</option>
                                <?php print_r($default ['customer']);
                                    foreach ($default ['customer'] as 
                                    $row) { ?> 
                                    <option value="<?php echo (isset ($row ['value'])) ? $row ['value'] :
                                    ''; ?>" <?php echo (isset($row ['selected']))? $row ['selected'] : 
                                    ''; ?>>
