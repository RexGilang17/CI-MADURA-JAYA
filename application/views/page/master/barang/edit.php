            ...
            <form action="<?php echo $url_post ?>" method="post">
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input type="text" readonly class="form-control" value="<?= $kodebarang; ?>" id="kodebarang" name="kodebarang" placeholder="Kode Barang" required>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" value="<?= $nm_barang; ?>" id="nm_barang" name="nm_barang" placeholder="Nama Barang" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="number" class="form-control" value="<?= $stock_mn; ?>" id="stock_mn" name="stock_mn" placeholder="Stock" required>
                        <div class="invalid-feedback">
